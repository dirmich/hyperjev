...
def adjudicate_teacher_drafts(
    ...
    manifest = {
        ...
        "qwen_model": qwen_manifest.get("model"),
        "gemma_model": gemma_manifest.get("model"),
        "qwen_prompt_version": qwen_manifest.get("prompt_version"),
        "gemma_prompt_version": gemma_manifest.get("prompt_version"),
        "sample_count": len(samples),
