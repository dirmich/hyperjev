...
_CONTROL_FAST_PATHS: tuple[tuple[str, tuple[tuple[str, ...], ...]], ...] = (
    (
        ...
        (
            ...
            ("the reachable target", "getting closer"),
            ...
            ("move nearer to", "selected object"),
            ("object can be reached", "moving closer"),
    ...
    (
        ...
        (
            ...
            ("continue ahead", "route remains open"),
            ("clear path",),
    ...
    (
        ...
        (
            ...
            ("safe space behind",),
            ("reverse into", "safe rear area"),
            ("move away from", "obstacle approaching ahead"),
    ...
    (
        ...
        (
            ...
            ("press", "button"),
            ("grasp", "handle"),
            ("grip the handle", "aligned with the end effector"),
